...
.method forEach(Lcom/mysql/jdbc/Extension;)V
    ...
    invoke-interface {v0}, Lcom/mysql/jdbc/ConnectionLifecycleInterceptor;->transactionBegun()Z
...
.method bridge synthetic forEach(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, v0}, Lcom/mysql/jdbc/ConnectionImpl$9;->forEach(Lcom/mysql/jdbc/Extension;)V
