...
.method forEach(Lcom/mysql/jdbc/Extension;)V
    ...
    invoke-interface {v0}, Lcom/mysql/jdbc/ConnectionLifecycleInterceptor;->rollback()Z
...
.method bridge synthetic forEach(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, v0}, Lcom/mysql/jdbc/ConnectionImpl$5;->forEach(Lcom/mysql/jdbc/Extension;)V
